...
class FilmControllerTest {
    ...
    void initialize() {
        ...
        film1 = Film.builder().name("Фильм 1").description("Описание фильма 1")
                .releaseDate(LocalDate.of(2011, 1, 1)).duration(111).build();
        film2 = Film.builder().id(1).name("Фильм 2").description("Описание фильма 2")
                .releaseDate(LocalDate.of(2012, 2, 2)).duration(222).build();
    }
    ...
    void checkFilmWithIncorrectReleaseDate() {
        Film film = Film.builder().id(1).name("Фильм").description("Описание фильма 1")
                .releaseDate(LocalDate.of(500, 1, 1)).duration(111).build();
        Exception exception = assertThrows(ValidationException.class, () -> filmController.createFilm(film));
